...
public class FoodTwo extends Actor {
    ...
    public FoodTwo(Main main, final Hamster hamster) {
        this.main = main;
        this.hamster = hamster;

        img = new Sprite(new Texture("Pictures/Other/Food/Two/ftwo.png"));
        img.setPosition(main.camera.viewportWidth/14, main.camera.viewportHeight/2 - main.camera.viewportHeight/5);

        button = new Sprite(new Texture("Pictures/Buttons/NonAnimation/Buy/buy.png"));
        button.setPosition(main.camera.viewportWidth/2 - button.getWidth(), main.camera.viewportHeight/2 - main.camera.viewportHeight/5);
